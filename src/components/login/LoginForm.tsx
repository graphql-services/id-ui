...
export class LoginForm extends React.Component<{}, ILoginFormState> {
  ...
  public render() {
    return (
      <div style={{ width: '368px', margin: '0 auto', padding: '32px 0 24px' }}>
        <div style={{ width: '100%', height: '44px', textAlign: 'center' }}>
          <img
            alt="logo"
            style={{ height: '60px' }}
        ...
        <Login defaultActiveKey={'tab1'} onSubmit={this.onSubmit}>
          <Tab key="tab1" tab="">
